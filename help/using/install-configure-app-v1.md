...
Uso del [!DNL Experience Manager] aplicación de escritorio, los recursos dentro de [!DNL Experience Manager] son fácilmente accesibles desde el escritorio local y se pueden utilizar en cualquier aplicación de escritorio. Assets se puede mostrar en el Finder de Mac o en el Explorador de Windows, editarse en las aplicaciones de escritorio y los cambios se vuelven a guardar en [!DNL Experience Manager], creando una nueva versión tras la carga.
...
* Asegúrese de que su [!DNL Experience Manager] La versión del servidor de es compatible con [!DNL Experience Manager] aplicación de escritorio. Consulte la [matriz de compatibilidad](release-notes-of-v1.md#compatibilitymatrix).
...
## Conexión a un [!DNL Experience Manager] instancia detrás de un Dispatcher {#connect-to-an-aem-instance-behind-a-dispatcher}
...
>[!NOTE]
>
>Cuando borra la caché, conserva los cambios no guardados. Todos los recursos que no se hayan registrado en [!DNL Experience Manager] se conservan y no se eliminan.
...
1. Edite el `Adobe Experience Manager Desktop.exe.config` con un editor de texto.
...
>[!MORELIKETHIS]
>
* Ver una [Introducción a [!DNL Experience Manager] aplicación de escritorio](https://experienceleague.adobe.com/en/docs/experience-manager-learn/assets/creative-workflows/aem-desktop-app) (5 minutos, 43 segundos).
