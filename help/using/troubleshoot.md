...
* [Configuración en el as a Cloud Service Experience Manager para ocultar recursos caducados](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/manage-digital-assets#hide-expired-assets-via-acp-api).
