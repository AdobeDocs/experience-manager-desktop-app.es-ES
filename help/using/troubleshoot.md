...
* **Prácticas recomendadas para evitar conflictos**: Para evitar posibles conflictos al colaborar en varios recursos, ve a [evitar conflictos de edición](using.md#adv-workflow-collaborate-avoid-conflicts).

* **Usar la carga de carpetas para carpetas jerárquicas grandes**: en lugar de usar la interfaz web de Assets u otros métodos, usa la aplicación de escritorio [!DNL Experience Manager] para cargar carpetas grandes. La aplicación carga los recursos en segundo plano mediante el registro y la supervisión. Consulte [cargar recursos en lotes](using.md#bulk-upload-assets).
...
>[!NOTE]
>
>Al trabajar con Asistencia al cliente de Adobe en una solicitud de soporte o un ticket, se le puede pedir que comparta los archivos de registro para ayudar al equipo de Asistencia al cliente a comprender el problema. Archiva toda la carpeta `Logs` y compártela con el contacto de Atención al cliente.
...
* [Configuración en el as a Cloud Service Experience Manager para ocultar recursos caducados](https://experienceleague.adobe.com/es/docs/experience-manager-cloud-service/content/assets/manage/manage-digital-assets#hide-expired-assets-via-acp-api).
